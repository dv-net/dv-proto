        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn find(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.transactions.v1.TransactionsService/Find",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("eproxy.transactions.v1.TransactionsService", "Find"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.transactions.v1.TransactionsService/GetInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "eproxy.transactions.v1.TransactionsService",
                        "GetInfo",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod transactions_service_server {
    ...
    for TransactionsServiceServer<T> {
        const NAME: &'static str = "eproxy.transactions.v1.TransactionsService";
    }
}
