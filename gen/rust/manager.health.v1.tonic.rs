...
pub mod health_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("manager.health.v1.HealthService", "GetHealthStatus"),
                );
...
pub mod health_service_server {
    ...
    pub trait HealthService: Send + Sync + 'static {
        async fn get_health_status(
            &self,
            request: tonic::Request<super::GetHealthStatusRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetHealthStatusResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/manager.health.v1.HealthService/GetHealthStatus" => {
                    ...
                    struct GetHealthStatusSvc<T: HealthService>(pub Arc<T>);
                    impl<
                        T: HealthService,
                    > tonic::server::UnaryService<super::GetHealthStatusRequest>
                    for GetHealthStatusSvc<T> {
                        type Response = super::GetHealthStatusResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as HealthService>::get_health_status(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = GetHealthStatusSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
    ...
    impl<T: HealthService> tonic::server::NamedService for HealthServiceServer<T> {
        const NAME: &'static str = "manager.health.v1.HealthService";
    }
}
