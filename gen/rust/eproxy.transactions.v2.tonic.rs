        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn find(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.transactions.v2.TransactionsService/Find",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("eproxy.transactions.v2.TransactionsService", "Find"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.transactions.v2.TransactionsService/GetInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "eproxy.transactions.v2.TransactionsService",
                        "GetInfo",
                    ),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn suggest_tx_fee(
            &mut self,
            request: impl tonic::IntoRequest<super::SuggestTxFeeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SuggestTxFeeResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.transactions.v2.TransactionsService/SuggestTxFee",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod transactions_service_server {
    ...
    pub trait TransactionsService: Send + Sync + 'static {
        ...
        async fn suggest_tx_fee(
            &self,
            request: tonic::Request<super::SuggestTxFeeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SuggestTxFeeResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/eproxy.transactions.v2.TransactionsService/Find" => {
                    ...
                    struct FindSvc<T: TransactionsService>(pub Arc<T>);
                    impl<
                        T: TransactionsService,
                    > tonic::server::UnaryService<super::FindRequest> for FindSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TransactionsService>::find(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/eproxy.transactions.v2.TransactionsService/GetInfo" => {
                    #[allow(non_camel_case_types)]
                    struct GetInfoSvc<T: TransactionsService>(pub Arc<T>);
                    impl<
                        T: TransactionsService,
                    ...
                    for GetInfoSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TransactionsService>::get_info(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/eproxy.transactions.v2.TransactionsService/SuggestTxFee" => {
                    #[allow(non_camel_case_types)]
                    struct SuggestTxFeeSvc<T: TransactionsService>(pub Arc<T>);
                    impl<
                        T: TransactionsService,
                    > tonic::server::UnaryService<super::SuggestTxFeeRequest>
                    for SuggestTxFeeSvc<T> {
                        type Response = super::SuggestTxFeeResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TransactionsService>::suggest_tx_fee(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SuggestTxFeeSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    for TransactionsServiceServer<T> {
        const NAME: &'static str = "eproxy.transactions.v2.TransactionsService";
    }
}
