        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn info(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.system.v2.SystemService/Info",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("eproxy.system.v2.SystemService", "Info"));
...
pub mod system_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/eproxy.system.v2.SystemService/Info" => {
                    ...
                    struct InfoSvc<T: SystemService>(pub Arc<T>);
                    impl<
                        T: SystemService,
                    > tonic::server::UnaryService<super::InfoRequest> for InfoSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SystemService>::info(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: SystemService> tonic::server::NamedService for SystemServiceServer<T> {
        const NAME: &'static str = "eproxy.system.v2.SystemService";
    }
}
