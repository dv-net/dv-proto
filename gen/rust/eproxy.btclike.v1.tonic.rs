        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn utxo(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.btclike.v1.BtcLikeService/UTXO",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("eproxy.btclike.v1.BtcLikeService", "UTXO"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.btclike.v1.BtcLikeService/MedianFeePerByteBlock",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "eproxy.btclike.v1.BtcLikeService",
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.btclike.v1.BtcLikeService/RemovedBlockList",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/eproxy.btclike.v1.BtcLikeService/RemovedBlock",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("eproxy.btclike.v1.BtcLikeService", "RemovedBlock"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod btc_like_service_server {
    ...
    impl<T: BtcLikeService> tonic::server::NamedService for BtcLikeServiceServer<T> {
        const NAME: &'static str = "eproxy.btclike.v1.BtcLikeService";
    }
}
