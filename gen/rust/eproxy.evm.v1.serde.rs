...
impl serde::Serialize for SuggestGasPriceRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.evm.v1.SuggestGasPriceRequest", len)?;
        if self.blockchain != 0 {
...
impl<'de> serde::Deserialize<'de> for SuggestGasPriceRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.evm.v1.SuggestGasPriceRequest")
            }
        ...
        deserializer.deserialize_struct("eproxy.evm.v1.SuggestGasPriceRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SuggestGasPriceResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.evm.v1.SuggestGasPriceResponse", len)?;
        if !self.gas_fee_wei.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SuggestGasPriceResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.evm.v1.SuggestGasPriceResponse")
            }
        ...
        deserializer.deserialize_struct("eproxy.evm.v1.SuggestGasPriceResponse", FIELDS, GeneratedVisitor)
    }
}
