...
pub mod subscriber_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn subscribe_mempool(
            &mut self,
            request: impl tonic::IntoRequest<super::SubscribeMempoolRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::SubscribeMempoolResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/watcher.subscriber.v1.SubscriberService/SubscribeMempool",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "watcher.subscriber.v1.SubscriberService",
                        "SubscribeMempool",
                    ),
                );
...
pub mod subscriber_service_server {
    ...
    pub trait SubscriberService: Send + Sync + 'static {
        ...
        type SubscribeMempoolStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::SubscribeMempoolResponse,
                    tonic::Status,
                >,
            >
            + Send
        ...
        async fn subscribe_mempool(
            &self,
            request: tonic::Request<super::SubscribeMempoolRequest>,
        ) -> std::result::Result<
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/watcher.subscriber.v1.SubscriberService/SubscribeMempool" => {
                    ...
                    struct SubscribeMempoolSvc<T: SubscriberService>(pub Arc<T>);
                    impl<
                        T: SubscriberService,
                    > tonic::server::ServerStreamingService<
                        super::SubscribeMempoolRequest,
                    > for SubscribeMempoolSvc<T> {
                        type Response = super::SubscribeMempoolResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SubscriberService>::subscribe_mempool(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    for SubscriberServiceServer<T> {
        const NAME: &'static str = "watcher.subscriber.v1.SubscriberService";
    }
}
