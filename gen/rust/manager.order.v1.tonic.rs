...
pub mod order_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn batch_create_order(
            &mut self,
            request: impl tonic::IntoRequest<super::BatchCreateOrderRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchCreateOrderResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("manager.order.v1.OrderService", "BatchCreateOrder"),
                );
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("manager.order.v1.OrderService", "CreateOrder"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("manager.order.v1.OrderService", "GetOrder"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("manager.order.v1.OrderService", "CancelOrder"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("manager.order.v1.OrderService", "ListOrders"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod order_service_server {
    ...
    pub trait OrderService: Send + Sync + 'static {
        async fn batch_create_order(
            &self,
            request: tonic::Request<super::BatchCreateOrderRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchCreateOrderResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/manager.order.v1.OrderService/BatchCreateOrder" => {
                    ...
                    struct BatchCreateOrderSvc<T: OrderService>(pub Arc<T>);
                    impl<
                        T: OrderService,
                    > tonic::server::UnaryService<super::BatchCreateOrderRequest>
                    for BatchCreateOrderSvc<T> {
                        type Response = super::BatchCreateOrderResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as OrderService>::batch_create_order(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = BatchCreateOrderSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
    ...
    impl<T: OrderService> tonic::server::NamedService for OrderServiceServer<T> {
        const NAME: &'static str = "manager.order.v1.OrderService";
    }
}
