...
impl serde::Serialize for MedianFeePerByteBlockRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.MedianFeePerByteBlockRequest", len)?;
        if self.number != 0 {
...
impl<'de> serde::Deserialize<'de> for MedianFeePerByteBlockRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.MedianFeePerByteBlockRequest")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.MedianFeePerByteBlockRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MedianFeePerByteBlockResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.MedianFeePerByteBlockResponse", len)?;
        if !self.amount.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MedianFeePerByteBlockResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.MedianFeePerByteBlockResponse")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.MedianFeePerByteBlockResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RemovedBlockInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.RemovedBlockInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for RemovedBlockInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.RemovedBlockInfo")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.RemovedBlockInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RemovedBlockListRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.RemovedBlockListRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for RemovedBlockListRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.RemovedBlockListRequest")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.RemovedBlockListRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RemovedBlockListResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.RemovedBlockListResponse", len)?;
        if !self.blocks.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RemovedBlockListResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.RemovedBlockListResponse")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.RemovedBlockListResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RemovedBlockRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.RemovedBlockRequest", len)?;
        if self.number != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("number", ToString::to_string(&self.number).as_str())?;
...
impl<'de> serde::Deserialize<'de> for RemovedBlockRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.RemovedBlockRequest")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.RemovedBlockRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RemovedBlockResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.RemovedBlockResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for RemovedBlockResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.RemovedBlockResponse")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.RemovedBlockResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UtxoRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.UTXORequest", len)?;
        if !self.address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for UtxoRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.UTXORequest")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.UTXORequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UtxoResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.UTXOResponse", len)?;
        if !self.items.is_empty() {
...
impl<'de> serde::Deserialize<'de> for UtxoResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.UTXOResponse")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.UTXOResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for utxo_response::Item {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("eproxy.btclike.v1.UTXOResponse.Item", len)?;
        if !self.tx_hash.is_empty() {
...
impl<'de> serde::Deserialize<'de> for utxo_response::Item {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct eproxy.btclike.v1.UTXOResponse.Item")
            }
        ...
        deserializer.deserialize_struct("eproxy.btclike.v1.UTXOResponse.Item", FIELDS, GeneratedVisitor)
    }
}
